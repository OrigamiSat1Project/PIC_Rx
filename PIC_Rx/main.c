...
//    volatile static int intr_counter;
    ...
    switch(RXDATA[1]){
        case 'p':/*'p 0x70':power*/
            putChar(0xa3);
            commandSwitchPowerSupply_forTX(RXDATA[2],RXDATA[3],RXDATA[4],RXDATA[5],RXDATA[6]);
            break;
    }
}
...
void main(void) {
    ...
    ******************************************************************************/
    ...
    putChar(0xf1);
    delay_ms(3000);
//    //write  melting_compelation_flag
...
//    WriteOneByteToEEPROM(MAIN_EEPROM_ADDRESS, HighAddress_for_commandID, LowAddress_for_commandID,0x01);
    ...
    putChar(0xf2);
    putChar(melting_compelation_flag);
    putChar(0xf3);
    
    //[melting_compelation_flag]over2 ->aleady developed / 1-> not yet
    if(melting_compelation_flag == 0x01){
//        putChar(0xf4);
