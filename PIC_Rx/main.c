...
////        //*------------Check NTRX sub power--------* 
////        //don't forget making TX can recieve subpower ON command
//        killEPS();
//        delay_s(3);
        //Turn on NTRX(from CIB)
//        onNtrxPowerSupplyCIB(0,0); 
//        WriteOneByteToEEPROM(MAIN_EEPROM_ADDRESS,0x8A,0x00,0xF3);
//        UBYTE send_command[8] = {0};
//        send_command[0] = 't';
//        send_command[1] = 'c';
//        send_command[2] = 0xaa;
//        send_command[3] = 0x50;
