...
//    LED_WHITE = 0;              //for debugging of PLL setting
    ...
    UBYTE command_for_debug[8] = {0x00};
    command_for_debug[0] = 't';
    command_for_debug[1] = 0x80;
    command_for_debug[3] = 0x00;
    command_for_debug[4] = 0x00;
    command_for_debug[5] = 0x00;
    command_for_debug[6] = 0x00;
    command_for_debug[7] = 0x00;
    while(1){
        sendCommandByPointer(command_for_debug);
        delay_s(5);
        putChar(0xdd);
        delay_s(5);
    }
    ...
    /* =========================================================================
     * comment out for usart interrupt, under this line
     * =========================================================================
     */
//    putChar('Y');
//    putChar('S');
