...
void cutWire(UBYTE onOff, UBYTE timeHigh, UBYTE timeLow){ //high->on
    ...
    melting_status++;
    WriteOneByteToEEPROM(MAIN_EEPROM_ADDRESS,MeltingStatus_addressHigh,MeltingStatus_addressLow, melting_status);
    WriteOneByteToEEPROM(SUB_EEPROM_ADDRESS,MeltingStatus_addressHigh,MeltingStatus_addressLow, melting_status);
